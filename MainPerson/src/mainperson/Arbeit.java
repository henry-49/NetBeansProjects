...
public class Arbeit {
  ...
  // Konstruktoren
  public Arbeit(String stellenname,String vorname,String nachname,
    ...
    public void identiefizieren(){
        System.out.println("Ich bin Chef");
    }
    
    public void datenAusgeben(){
        System.out.println("Stellenname: "+stellenname+ "\n"+
                            "Vorname: "+vorname+ "\n"+ 
                           "Nachname: "+nachname+"\n"+
                            "Alter: "+alter+"\n"+
                            "Email: "+emial+"\n"+
